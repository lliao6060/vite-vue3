...
<template>
  <div class="d-grid compo-row grid-cols-sm-1 grid-cols-md-2">
    <div class="w-100 h-100">
      <h3 class="vrwd card-title">手風琴</h3>
      <div class="compo-item w-100 h-100">
        <t-accordion-example />
      </div>
    </div>
    <div class="w-100 h-100">
      <h3 class="vrwd card-title">倒數計時</h3>
      <div class="compo-item w-100 h-100">
    ...
    <div class="w-100 h-100">
      <h3 class="vrwd card-title">vue3-lazyload</h3>
      <div class="compo-item w-100 h-100">
        <img v-lazy="getImageUrl('maju/maju.jpg')" class="d-block w-100 h-100" />
      </div>
    </div>
    <div class="w-100 h-100">
      <h3 class="vrwd card-title">swiper with lightbox</h3>
      <div class="compo-item w-100 h-100">
    ...
    >
      <div class="compo-item w-100 h-100">
        <p class="align-center ">點空白區域開啟長內容彈窗</p>
      </div>
    </div>
    <div class="w-100 h-100">
      <h3 class="vrwd card-title">一鍵導出excel</h3>
      <div class="compo-item w-100 h-100">
        <a
          href="#"
    ...
    <div class="w-100 h-100">
      <h3 class="vrwd card-title">Icons</h3>
      <div class="compo-item w-100 h-100">
